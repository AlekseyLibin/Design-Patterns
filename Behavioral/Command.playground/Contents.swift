...
class Deposit: Command {
    private var _account: Account // названия private свойств принято начинать с '_'
    private var _amount: Int // названия private свойств принято начинать с '_'
...
let account = Account(accountName: "Aleksey Libin", balance: 1000)
